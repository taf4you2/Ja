...
namespace Ja.Services
{
    ...
    public class DataInitializationService
    {
        ...
        /// <summary>
        /// Inicjalizuje domyślnego użytkownika z podstawowymi danymi
        ...
        /// <summary>
        /// Inicjalizuje domyślne ustawienia aplikacji
        /// </summary>
        private async Task InitializeDefaultSettings(int userId)
        {
